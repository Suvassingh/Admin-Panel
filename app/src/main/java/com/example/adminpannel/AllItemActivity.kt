...
import com.example.adminpannel.Adapter.MenuItemAdapter
import com.example.adminpannel.databinding.ActivityAllItemBinding
...
class AllItemActivity : AppCompatActivity() {
    ...
    private fun deleteMenuItems(position: Int) {
        ...
        val foodMenuReference = database.reference.child("menu").child(menuItemKey.toString())
